...
int main()
{
   char dow;
     ...
     int arr3=0;
       ...
       cout << "Press 1 Edit or Delete or Add Student" << endl;
       cout << "Press 2 Edit or Delete or Add Staff" << endl;
       ...
       switch(sw2)
    {
        case  1 :
         ...
         cout << "You Can Edit or Add or Delete Student Records.. \n";
        ...
        case 2:
            ...
            if(id2==stud[j].id)
            {
                ...
                cout << "\t Record Successfully Deleted";
                    ...
                    break;
        case 3:
            cout << "\n Enter the ID Number of the Student to Edit: " << endl;
